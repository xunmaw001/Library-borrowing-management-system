		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">缴纳罚金管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">缴纳罚金列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">缴纳罚金列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('jieyuedanhao')">借阅单号<i id="jieyuedanhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('fakuanshuoming')">罚款说明<i id="fakuanshuomingIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('fakuanjine')">罚款金额<i id="fakuanjineIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('fakuanriqi')">罚款日期<i id="fakuanriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var jieyuedanhaoCell  = document.createElement('td');
									...
									row.appendChild(tushumingchengCell);
				            				var fakuanshuomingCell  = document.createElement('td');

												 fakuanshuomingCell.innerHTML = item.fakuanshuoming;

				
									row.appendChild(fakuanshuomingCell);
				            				var fakuanjineCell  = document.createElement('td');

												 fakuanjineCell.innerHTML = item.fakuanjine;

				
									row.appendChild(fakuanjineCell);
				            				var fakuanriqiCell  = document.createElement('td');

												  fakuanriqiCell.innerHTML = item.fakuanriqi;

				
									row.appendChild(fakuanriqiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiaonafajin/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jiaonafajin");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"jiaonafajin");
