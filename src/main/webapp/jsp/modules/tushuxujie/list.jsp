...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">图书续借管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">图书续借管理</li>
								<li class="breadcrumb-item active">图书续借列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">图书续借列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('jieyuedanhao')">借阅单号<i id="jieyuedanhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('xujietianshu')">续借天数<i id="xujietianshuIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('xujieriqi')">续借日期<i id="xujieriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var jieyuedanhaoCell  = document.createElement('td');
									...
									row.appendChild(yinghairiqiCell);
				            				var xujietianshuCell  = document.createElement('td');

												 xujietianshuCell.innerHTML = item.xujietianshu;

				
									row.appendChild(xujietianshuCell);
				            				var xujieriqiCell  = document.createElement('td');

												  xujieriqiCell.innerHTML = item.xujieriqi;

				
									row.appendChild(xujieriqiCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("tushuxujie/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("tushuxujie/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tushuxujie/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"tushuxujie");
