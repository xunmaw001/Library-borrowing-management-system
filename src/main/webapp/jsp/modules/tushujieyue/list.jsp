		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">图书借阅管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">图书借阅管理</li>
								<li class="breadcrumb-item active">图书借阅列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">图书借阅列表</h3>							
											...
											<th class="no-sort" style="min-width: 35px;">
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('jieyuedanhao')">借阅单号<i id="jieyuedanhaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('jieyueriqi')">借阅日期<i id="jieyueriqiIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('jieyuetianshu')">借阅天数<i id="jieyuetianshuIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('yinghairiqi')">应还日期<i id="yinghairiqiIcon" class="fa fa-sort"></i></th>
																																																			<th onclick="sort('jieyuezhuangtai')">借阅状态<i id="jieyuezhuangtaiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
							...
							var jieyuedanhaoCell  = document.createElement('td');

												 jieyuedanhaoCell.innerHTML = item.jieyuedanhao;

				
									row.appendChild(jieyuedanhaoCell);
									...
									row.appendChild(kejieshuliangCell);
				            				var jieyueriqiCell  = document.createElement('td');

												  jieyueriqiCell.innerHTML = item.jieyueriqi;

				
									row.appendChild(jieyueriqiCell);
				            				var jieyuetianshuCell  = document.createElement('td');

												 jieyuetianshuCell.innerHTML = item.jieyuetianshu;

				
									row.appendChild(jieyuetianshuCell);
				            				var yinghairiqiCell  = document.createElement('td');

												  yinghairiqiCell.innerHTML = item.yinghairiqi;

				
									row.appendChild(yinghairiqiCell);
				            				var jieyuezhuangtaiCell  = document.createElement('td');

												  jieyuezhuangtaiCell.innerHTML = item.jieyuezhuangtai; 
                
									row.appendChild(jieyuezhuangtaiCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("tushujieyue/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("tushujieyue/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tushujieyue/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"tushujieyue");
