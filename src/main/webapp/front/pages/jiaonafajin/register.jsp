      ...
      <div class="form-inner">
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="fakuanshuoming" name="fakuanshuoming" placeholder="请输入罚款说明" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="fakuanjine" name="fakuanjine" placeholder="请输入罚款金额" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
