						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="tupianUpload">
									<i class="layui-icon">&#xe67c;</i>上传图片
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">建馆时间</label>
							<div class="layui-input-block">
								<input type="text" name="jianguanshijian" id="jianguanshijian" placeholder="建馆时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="dizhi" id="dizhi" placeholder="地址" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">图书馆介绍</label>
							<div class="layui-input-block">
								<input type="text" name="tushuguanjieshao" id="tushuguanjieshao" placeholder="图书馆介绍" autocomplete="off" class="layui-input">
							</div>
						</div>
