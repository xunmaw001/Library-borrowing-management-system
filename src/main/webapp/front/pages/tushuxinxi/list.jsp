        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="tushuleixing" id="tushuleixing" placeholder="图书类型" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
            ...
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('tushuxinxi','新增')" @click="jump('../tushuxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../tushuxinxi/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.tupian?item.tupian.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
                  <h5>{{item.tushumingcheng}}</h5>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#tushuleixing').val()) {
          param['tushuleixing'] = jquery('#tushuleixing').val() ? '%' + jquery('#tushuleixing').val() + '%' : '';
        }  
        if (jquery('#zuozhe').val()) {
          param['zuozhe'] = jquery('#zuozhe').val() ? '%' + jquery('#zuozhe').val() + '%' : '';
        }  
        if (jquery('#tushuguanmingcheng').val()) {
          param['tushuguanmingcheng'] = jquery('#tushuguanmingcheng').val() ? '%' + jquery('#tushuguanmingcheng').val() + '%' : '';
        }  
        // 获取列表数据
