      ...
      <div class="form-inner">
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="shujialeibie" name="shujialeibie" placeholder="请输入书架类别" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="tushujiage" name="tushujiage" placeholder="请输入图书价格" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
