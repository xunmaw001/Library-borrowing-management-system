				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('tushujieyue','续借')" @click="onAcrossTap('tushuxujie')" type="button" class="layui-btn">
								续借
							</button>
																					<button v-if="isAuth('tushujieyue','归还')" @click="onAcrossTap('tushuguihai')" type="button" class="layui-btn">
								归还
							</button>
