					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="tushubianhao" id="tushubianhao" placeholder="图书编号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="tushuguanmingcheng" id="tushuguanmingcheng" placeholder="图书馆名称" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="jieyueriqi" id="jieyueriqi" placeholder="借阅日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">借阅天数</label>
							<div class="layui-input-block">
								<input type="text" name="jieyuetianshu" id="jieyuetianshu" placeholder="借阅天数" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">应还日期</label>
							<div class="layui-input-block">
								<input type="text" name="yinghairiqi" id="yinghairiqi" placeholder="应还日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">借阅状态</label>
							<div class="layui-input-block">
								<select name="jieyuezhuangtai" id="jieyuezhuangtai">
